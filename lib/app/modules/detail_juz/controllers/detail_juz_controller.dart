...
class DetailJuzController extends GetxController {
  ...
  Future<Juz?> getJuz(int nomorJuz) async {
    //tangkap parameter
    String url =
        "https://quran-api-id.vercel.app/juz/$nomorJuz"; //menyesuaikan dari parameter

    var response = await http.get(Uri.parse(url));

    if (response.statusCode == 200) {
      final data = jsonDecode(response.body);
      final detailJuz = data["data"];
      return Juz.fromJson(detailJuz);
    }
    return null;
  }
